...
# Global settings for XHCI controllers
$globalInterval = 0x0
$globalHCSPARAMSOffset = 0x4
$globalRTSOFF = 0x18

# User-defined settings to override global values
$userDefinedData = @{}

# Path to Rw.exe
$rwePath = "C:\RW-Everything\Rw.exe"
...
# Retrieves value from a specific memory address
